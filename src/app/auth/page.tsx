          ...
          <div className="glass-effect p-8 rounded-xl border border-white/10">
            <div className="mb-4">
              ...
              <p className="text-xs text-muted-foreground">
                Utilisez ces identifiants pour explorer l&apos;app
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground list-disc list-inside">
                <li>
                  <span className="text-white">Diète</span>: ajoutez des repas,
                  utilisez les <em>menu‑types</em>, voyez les recommandations
                  coach et messages du jour.
                </li>
                <li>
                  <span className="text-white">Entraînements</span>:
                  créez/éditez vos séances, import Garmin, graphiques (volume,
                  FC, perf).
                </li>
                <li>
                  <span className="text-white">Mesures & Photos</span>:
                  enregistrez vos mesures, comparez vos photos avant/après.
                </li>
                <li>
                  <span className="text-white">Journal</span>: notez
                  humeur/énergie, ajoutez des photos libres, suivez les
                  objectifs et badges.
                </li>
                <li>
                  <span className="text-white">Commentaires coach</span>:
                  visibles dans chaque module à la date ou l’élément concerné;
                  marquez comme lus.
                </li>
              </ul>
            </div>
