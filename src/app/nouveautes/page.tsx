        ...
        >
          <div className="space-y-4">
            ...
            <div className="bg-neon-purple/10 p-4 rounded-lg border border-neon-purple/20">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-200 space-y-2">
                <li>
                  Design cohérent sur toutes les pages (Journal, Diète,
                  Entraînements, Mesures, Challenges)
                </li>
                ...
                <li>
                  Boutons d&apos;action flottants (FAB) pour un accès rapide aux
            ...
            <div className="bg-neon-pink/10 p-4 rounded-lg border border-neon-pink/20">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-200 space-y-2">
                <li>
                  <strong>Journal</strong> : Interface épurée avec entrées
                  compactes et historique optimisé
                </li>
                <li>
                  <strong>Diète</strong> : Barres de progression visuelles et
                  conseils nutritionnels intelligents
                </li>
                <li>
                  <strong>Entraînements</strong> : Formulaires en modal et suivi
                  de performance amélioré
                </li>
                <li>
                  <strong>Mesures</strong> : Indicateurs de santé avec zones de
                  référence médicales
                </li>
                <li>
                  <strong>Challenges</strong> : Système de gamification complet
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-700/30 p-4 rounded-lg border border-gray-600">
              <h4 className="font-semibold text-white mb-3">
                v1.13.0 — ⚡ Optimisations Dashboard & Diète
              </h4>
              <div className="space-y-3">
                <div className="bg-neon-green/10 p-3 rounded-lg border border-neon-green/20">
                  <h5 className="font-semibold text-neon-green mb-2">
                    ⚡ Centralisation Énergétique
                  </h5>
                  <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
                    <li>
                      <strong>Hook useEnergyBalance</strong> : Calculs
                      TDEE/sport centralisés pour cohérence absolue
                    </li>
                    <li>
                      <strong>Pondération sport</strong> : Correction double
                      comptage selon niveau activité (facteur 0.1-0.9)
                    </li>
                    <li>
                      <strong>Tests complets</strong> : 4 scénarios de
                      validation pour fiabilité
                    </li>
                    <li>
                      <strong>Performance</strong> : Suppression de 45 lignes de
                      code dupliqué
                    </li>
                  </ul>
                </div>
                <div className="bg-neon-cyan/10 p-3 rounded-lg border border-neon-cyan/20">
                  <h5 className="font-semibold text-neon-cyan mb-2">
                    📅 Correction Calcul Semaine
                  </h5>
                  <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
                    <li>
                      <strong>Standard français</strong> : Semaine
                      lundi→dimanche (ISO 8601)
                    </li>
                    <li>
                      <strong>4 fichiers corrigés</strong> : Dashboard, Mobile,
                      Entrainements, Challenges
                    </li>
                    <li>
                      <strong>Mode semaine fonctionnel</strong> : Données
                      complètes 7 jours
                    </li>
                    <li>
                      <strong>Impact UX</strong> : Plus de graphiques vides le
                      dimanche
                    </li>
                  </ul>
                </div>
                <div className="bg-neon-purple/10 p-3 rounded-lg border border-neon-purple/20">
                  <h5 className="font-semibold text-neon-purple mb-2">
                    📊 Page Diète Révolutionnaire
                  </h5>
                  <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
                    <li>
                      <strong>Header macros</strong> : 4 barres progression +
                      conseils intelligents + toggle période
                    </li>
                    <li>
                      <strong>Sections collapsibles</strong> : Réduction 60%
                      hauteur page, charge cognitive optimisée
                    </li>
                    <li>
                      <strong>Analyse evidence-based</strong> : 5 insights
                      scientifiques (timing, régularité, protéines, tendances,
                      diversité)
                    </li>
                    <li>
                      <strong>UX coach optimisée</strong> : Suppression double
                      clic, intégration directe
                    </li>
                    <li>
                      <strong>Objectifs adaptatifs</strong> : Multiplication
                      automatique selon période (jour/semaine)
                    </li>
                  </ul>
                </div>
                <div className="bg-neon-yellow/10 p-3 rounded-lg border border-neon-yellow/20">
                  <h5 className="font-semibold text-neon-yellow mb-2">
                    📈 Graphiques Motivationnels
                  </h5>
                  <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
                    <li>
                      <strong>Domaines dynamiques</strong> : Y-axis adapté aux
                      données utilisateur pour amplifier progrès
                    </li>
                    <li>
                      <strong>Statistiques motivantes</strong> : Changement
                      total, pourcentage, tendance récente
                    </li>
                    <li>
                      <strong>Adaptation période</strong> : Filtrage données
                      selon sélection (aujourd&apos;hui/semaine/mois)
                    </li>
                    <li>
                      <strong>Visual feedback</strong> : Dots plus gros,
                      couleurs motivantes, marges asymétriques
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-gray-700/30 p-4 rounded-lg border border-gray-600">
              <h4 className="font-semibold text-white mb-2">
                v1.9.2 — 🎨 Interface Moderne & Export de Données
              </h4>
              <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
            ...
            <div className="bg-gray-700/30 p-4 rounded-lg border border-gray-600">
              <h4 className="font-semibold text-white mb-2">
                v1.9.1 — 🎨 Interface Coach Améliorée
              </h4>
              <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
            ...
            <div className="bg-gray-700/30 p-4 rounded-lg border border-gray-600">
              <h4 className="font-semibold text-white mb-2">
                v1.8.4 — 📊 Gestion Complète des Athlètes
              </h4>
              <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
            ...
            <div className="bg-gray-700/30 p-4 rounded-lg border border-gray-600">
              <h4 className="font-semibold text-white mb-2">
                v1.8.3 — 🛡️ Gestion d&apos;Erreurs Améliorée
              </h4>
              <ul className="list-disc pl-5 text-sm text-gray-200 space-y-1">
