...
export function useQuickActions() {
  ...
  const getContext = useCallback((): QuickActionContext => {
    ...
    switch (page) {
      case 'diete':
        availableActions = ['quick-meal', 'template-meal', 'scan-barcode', 'voice-input']
        break
      case 'entrainements':
        availableActions = ['quick-training', 'template-training', 'import-garmin', 'timer']
        break
      case 'mesures':
        availableActions = ['quick-weight', 'full-measures', 'photo-progress', 'body-scan']
        break
      case 'journal':
        availableActions = ['quick-mood', 'voice-note', 'photo-libre', 'goal-check']
        break
      default:
        availableActions = ['add-meal', 'add-training', 'add-measure', 'journal-entry']
    }
