...
export default function DietForm({
      ...
      case 'favorites':
        return (
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1">
              <FavoritesFoodList onSelectFood={handleAddFromFavorites} />
            </div>
          </div>
        );
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-400">
                          {aliment.quantite}
                          {aliment.unite} •{' '}
                          {Math.round(aliment.macros?.kcal || 0)} kcal
                        </div>
                      </div>
                  ...
                  <div className="mt-4 p-4 bg-gradient-to-r from-neon-purple/10 to-neon-cyan/10 rounded-lg border border-neon-purple/20">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-semibold text-neon-green">
                      ...
                      <div>
                        ...
                        <span className="ml-2 font-semibold text-neon-cyan">
                          {Math.round(totalMacros.prot)}g
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-400">Glucides:</span>
                        <span className="ml-2 font-semibold text-neon-yellow">
                          {Math.round(totalMacros.glucides)}g
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-400">Lipides:</span>
                        <span className="ml-2 font-semibold text-neon-pink">
                          {Math.round(totalMacros.lipides)}g
                        </span>
                      </div>
                    </div>
                  </div>
  ...
  return (
    <FormModal
      ...
      activeTab={activeTab}
      onTabChange={(tabId) =>
        setActiveTab(tabId as 'search' | 'manual' | 'favorites' | 'summary')
      }
