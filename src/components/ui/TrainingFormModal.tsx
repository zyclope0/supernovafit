...
export default function TrainingFormModal({
  ...
  return (
    <StandardModal
      isOpen={isOpen}
      onClose={onClose}
      title={editingTraining ? 'Modifier l\'entraînement' : 'Nouvel entraînement'}
      subtitle={editingTraining ? 'Modifiez les données de votre entraînement' : 'Ajoutez un nouvel entraînement à votre planning'}
      icon="🏋️"
      maxWidth={maxWidth}
      height="85vh"
    >
