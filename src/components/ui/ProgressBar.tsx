...
export default function ProgressBar({ 
  ...
  const progressPercentage = Math.round((levelInfo.currentLevelXP / levelInfo.nextLevelXP) * 100)
      ...
      <div className="glass-effect rounded-lg p-4 border border-white/20">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-white">Niveau {progress.level}</span>
          </div>
    ...
    <div className="glass-effect rounded-xl p-6 border border-white/20">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm text-white/70">Progression vers le niveau {progress.level + 1}</span>
      ...
      {showDetails && (
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
            ...
            <div>
              <div className="text-lg font-bold text-white">{progress.badgesCount}</div>
          ...
          <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
            ...
            <div>
              <div className="text-lg font-bold text-white">{progress.challengesCompleted}</div>
          ...
          <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
            ...
            <div>
              <div className="text-lg font-bold text-white">{progress.achievementsUnlocked}</div>
          ...
          <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
            ...
            <div>
              <div className="text-lg font-bold text-white">{progress.streakDays}</div>
