...
export default function MesuresFormModal({
  ...
  // Synchroniser les données quand editingMesure change
  useEffect(() => {
    if (editingMesure) {
      setFormData({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      (isNaN(masseGrasse) || masseGrasse < 0 || masseGrasse > 100)
    ) {
    ...
    if (
      formData.masse_musculaire &&
      (isNaN(masseMusculaire) || masseMusculaire < 0 || masseMusculaire > 100)
    ) {
    ...
    if (
      formData.tour_taille &&
      (isNaN(tourTaille) || tourTaille <= 0 || tourTaille > 200)
    ) {
    ...
    if (
      formData.tour_hanches &&
      (isNaN(tourHanches) || tourHanches <= 0 || tourHanches > 200)
    ) {
    ...
    if (
      formData.tour_bras &&
      (isNaN(tourBras) || tourBras <= 0 || tourBras > 100)
    ) {
    ...
    if (
      formData.tour_cuisses &&
      (isNaN(tourCuisses) || tourCuisses <= 0 || tourCuisses > 150)
    ) {
    ...
    if (
      formData.tour_cou &&
      (isNaN(tourCou) || tourCou <= 0 || tourCou > 100)
    ) {
    ...
    if (
      formData.tour_poitrine &&
      (isNaN(tourPoitrine) || tourPoitrine <= 0 || tourPoitrine > 200)
    ) {
    ...
    if (!hasImportantData) {
      errors.push(
        'Veuillez remplir au moins une mesure importante (poids, taille, masse grasse, etc.)',
      );
    }
  ...
  return (
    <StandardModal
      ...
      subtitle={
        editingMesure
          ? 'Modifiez les données de votre mesure'
          : 'Ajoutez une nouvelle mesure corporelle'
      }
      icon="📏"
      maxWidth="4xl"
      height="85vh"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, masse_grasse: e.target.value })
                }
                className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                placeholder="15.5"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, masse_musculaire: e.target.value })
                }
                className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                placeholder="40.0"
              />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, tour_taille: e.target.value })
                  }
                  className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                  placeholder="80"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, tour_hanches: e.target.value })
                  }
                  className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                  placeholder="95"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, tour_bras: e.target.value })
                  }
                  className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                  placeholder="32"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, tour_cuisses: e.target.value })
                  }
                  className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                  placeholder="55"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, tour_cou: e.target.value })
                  }
                  className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                  placeholder="38"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, tour_poitrine: e.target.value })
                  }
                  className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-lg text-white focus:border-neon-purple focus:outline-none"
                  placeholder="100"
                />
