          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-400">
                {Math.round(((totalMacros.protein * 4) / totalCalories) * 100)}%
                des calories
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-gray-400">
                {Math.round(((totalMacros.carbs * 4) / totalCalories) * 100)}%
                des calories
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-gray-400">
                {Math.round(((totalMacros.fat * 9) / totalCalories) * 100)}% des
                calories
              </div>
            </div>
          </div>
            ...
            {items.map((item, index) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-gray-400">
                    P: {Math.round(item.protein)}g | G: {Math.round(item.carbs)}
                    g | L: {Math.round(item.fat)}g
                  </div>
                </div>
              </div>
            ))}
