  ...
  return (
    ...
    >
      <div className="p-6 pb-4 overflow-y-auto max-h-full">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {stats?.imc && (
            <div className="glass-effect p-4 rounded-lg border border-white/10">
              ...
              <div className="text-2xl font-bold text-neon-cyan">{stats.imc}</div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {mesure.masse_musculaire && (
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  <span className="text-lg">💪</span>
                  <span className="text-sm text-gray-400">Masse musculaire</span>
                </div>
                <div className="text-xl font-bold text-neon-purple">{mesure.masse_musculaire}%</div>
                <div className="text-xs text-gray-400">pourcentage</div>
              </div>
            )}
          </div>
        ...
        <div className="glass-effect p-4 rounded-lg border border-white/10">
          ...
          <div className="space-y-3">
            ...
            {mesure.tour_hanches && (
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                <div className="flex-1">
                  <div className="font-medium text-white">Tour de hanches</div>
                  <div className="text-sm text-gray-400">Circonférence</div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-semibold text-neon-pink">{mesure.tour_hanches} cm</div>
                </div>
              </div>
            )}
            {mesure.tour_bras && (
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                ...
                <div className="text-right">
                  <div className="text-sm font-semibold text-neon-cyan">{mesure.tour_bras} cm</div>
                </div>
              </div>
            )}
            {mesure.tour_cuisses && (
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                <div className="flex-1">
                  <div className="font-medium text-white">Tour de cuisses</div>
                  <div className="text-sm text-gray-400">Circonférence</div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-semibold text-neon-green">{mesure.tour_cuisses} cm</div>
                </div>
              </div>
            )}
            {mesure.tour_cou && (
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                ...
                <div className="text-right">
                  <div className="text-sm font-semibold text-neon-yellow">{mesure.tour_cou} cm</div>
                </div>
              </div>
            )}
            {mesure.tour_poitrine && (
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                <div className="flex-1">
                  <div className="font-medium text-white">Tour de poitrine</div>
                  <div className="text-sm text-gray-400">Circonférence</div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-semibold text-neon-orange">{mesure.tour_poitrine} cm</div>
                </div>
              </div>
            )}
          </div>
        ...
        {stats && (stats.evolution_poids !== 0 || stats.evolution_masse_grasse !== 0) && (
          <div className="glass-effect p-4 rounded-lg border border-white/10">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-2xl">📈</span>
              Évolutions
            ...
            <div className="space-y-3">
              ...
              {stats.evolution_masse_grasse !== 0 && (
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <div className="flex-1">
                    <div className="font-medium text-white">Évolution masse grasse</div>
                    <div className="text-sm text-gray-400">Variation</div>
                  </div>
                  <div className="text-right">
                    <div className={`text-sm font-semibold ${
                      stats.evolution_masse_grasse < 0 ? 'text-neon-green' : 'text-neon-red'
                    }`}>
                      {stats.evolution_masse_grasse > 0 ? '+' : ''}{stats.evolution_masse_grasse}%
                    </div>
                  </div>
                </div>
              )}
